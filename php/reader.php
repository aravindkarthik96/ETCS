    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Reader maintenance</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form role="form" action="change.php?c=mickeighekl31121" method="post">
                                        <div class="form-group">
                                            <label>coordinates</label>
                                            <input type="text" class="form-control" name="rcoordinates" placeholder="Enter Coordinates" required>
                                        </div>
                                        <div class="form-group">
                                            <label>location</label>
                                            <input type="text" class="form-control" name="rlocation" placeholder="Enter Location" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Status</label>
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            while ($row=mysql_fetch_array($data)) {
                                ...
                                echo $row['location'];
                                echo "</td><td>";
                                echo "<a href='change.php?c=xkkdkkkdqqny4222&id=".$row['reader_id']."'><button type='button' class='btn btn-warning btn-circle'><i class='fa fa-times'></i>
                            </button></a>";
                                echo "</td></tr>";
                            }
                            ?>
